package com.satria.javatestframework.utils.Encryption;

import java.util.Base64;
import java.util.StringTokenizer;

import static com.satria.javatestframework.utils.Utils.RandomGenerator.GenerateRandomAlphaNumericCharacters;
import static com.satria.javatestframework.utils.Utils.RandomGenerator.GenerateRandomNumber;
...
public class Encryption {
    ...
    public static String encrypt64(String str1, String str2) {
        return new String(Base64.getEncoder().encode((str1 + ":" + str2).getBytes()));
    }

    public static void main(String[] args) throws Exception {
        System.out.println(encryptData("ApproverFM!@#456"));
